...
draw.text((0, top + 31), 'H' + forecast[0]['High'] + ' L' + forecast[0]['Low'] + ' ' + forecast[0]['Icon'] , font=font, fill=255)
draw.text((0, top + 47), 'H' + forecast[1]['High'] + ' L' + forecast[1]['Low'] + ' ' + forecast[1]['Icon'] , font=font, fill=255)
